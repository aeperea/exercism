...
describe('Acronyms are produced from', function () {
  ...
  it('phrases in spanish', function () {
    expect(_acronym2['default'].parse('Ratas gigantes caras de perro')).toEqual('RGCDP');
  });

  it('known acrynom', function () {
    expect(_acronym2['default'].parse('New York Police Department')).toEqual('NYPD');
  });
});